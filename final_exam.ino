/*
 * Title of the project: The Humidity Fan
 * 
 * Description:
 ...
 * 
 * Author: Davide Barbagallo
 * Creation date: 30 Nov 2024
 * Last Edit date: 09 Dec 2024
 * 
 * Use components:
 * - Arduino UNO
...
void loop() {
  ...
  } else { // If results != 0 than an error occurred and we cannot read new data
  ...
  } else { // If read humidity is less than HUMIDITY_THRESHOLD (defined above) OR there was enough consecutive errors, then we can stop the motor
